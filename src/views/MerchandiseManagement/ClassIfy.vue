                ...
                <el-tabs @tab-click="handle" v-model="activeName">
                    <el-tab-pane v-for="(el, i) in categoryList" :key="i" :label="el.name" :name="el.name">
                        ...
                        <el-table height="600" :data="foodList" style="width: 100%">
                            <el-table-column label="菜肴图片" width="220">
                                <template slot-scope="scope">
                                    <img class="banner-food_png" :src="scope.row.bannerUrl" alt="">
                                </template>
                            </el-table-column>
                            <el-table-column prop="foodName" label="菜肴名称" width="200">
                            </el-table-column>
                            <el-table-column prop="description" label="菜肴描述" width="300">
                            </el-table-column>
                            <el-table-column align="center" label="菜肴价格" width="200">
                                <template slot-scope="scope">
                                    <span>{{ scope.row.price + '元' }}</span>
                                </template>
                            </el-table-column>

                            <el-table-column align="center" label="菜肴操作" width="260">
                                <template slot-scope="scope">
